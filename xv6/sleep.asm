  ...
  11:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  32:	e8 f9 01 00 00       	call   230 <atoi>
  if(n < 0){
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 0e                	js     4c <main+0x4c>
  ...
  41:	50                   	push   %eax
  42:	e8 ec 02 00 00       	call   333 <sleep>
  exit();
  47:	e8 57 02 00 00       	call   2a3 <exit>
    printf(2, "sleep: ticks invalidos\n");
  4c:	50                   	push   %eax
  4d:	50                   	push   %eax
  4e:	68 1c 07 00 00       	push   $0x71c
  53:	6a 02                	push   $0x2
  55:	e8 a6 03 00 00       	call   400 <printf>
    exit();
  5a:	e8 44 02 00 00       	call   2a3 <exit>
  5f:	90                   	nop
 ...
 409:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 580:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 585:	bb 34 07 00 00       	mov    $0x734,%ebx
