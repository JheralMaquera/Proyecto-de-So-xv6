   ...
   e:	bf 89 88 88 88       	mov    $0x88888889,%edi
{
  ...
  int total_segundos = ticks / 100;
  23:	b8 1f 85 eb 51       	mov    $0x51eb851f,%eax
  printf(1, "--------------------------------------\n");
  ...
  36:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
  39:	c1 fa 05             	sar    $0x5,%edx
  3c:	89 d6                	mov    %edx,%esi
  3e:	29 c6                	sub    %eax,%esi
  int minutos = total_segundos / 60;
  40:	89 f0                	mov    %esi,%eax
  42:	f7 ef                	imul   %edi
  44:	89 f0                	mov    %esi,%eax
  46:	c1 f8 1f             	sar    $0x1f,%eax
  49:	8d 1c 32             	lea    (%edx,%esi,1),%ebx
  4c:	c1 fb 05             	sar    $0x5,%ebx
  4f:	29 c3                	sub    %eax,%ebx
  printf(1, "--------------------------------------\n");
  ...
  9d:	6b c2 3c             	imul   $0x3c,%edx,%eax
  a0:	29 c3                	sub    %eax,%ebx
  printf(1, "Tiempo Activo : %d h, %d min, %d seg\n", horas, minutos, segundos);
  a2:	53                   	push   %ebx
  a3:	52                   	push   %edx
  a4:	68 a0 07 00 00       	push   $0x7a0
  a9:	6a 01                	push   $0x1
  ...
  b8:	6a 01                	push   $0x1
  ba:	e8 b1 03 00 00       	call   470 <printf>
  
  exit();
  bf:	e8 4f 02 00 00       	call   313 <exit>
  c4:	66 90                	xchg   %ax,%ax
  c6:	66 90                	xchg   %ax,%ax
  c8:	66 90                	xchg   %ax,%ax
  ca:	66 90                	xchg   %ax,%ax
 ...
 3d8:	89 d1                	mov    %edx,%ecx
{
 ...
 40b:	0f b6 92 8c 08 00 00 	movzbl 0x88c(%edx),%edx
 ...
 479:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4e4:	ff 24 85 34 08 00 00 	jmp    *0x834(,%eax,4)
 ...
 5ca:	52                   	push   %edx
 5cb:	57                   	push   %edi
 5cc:	e8 62 fd ff ff       	call   333 <write>
        ap++;
 ...
 601:	a1 38 0b 00 00       	mov    0xb38,%eax
{
 ...
 63f:	5b                   	pop    %ebx
  freep = p;
 640:	a3 38 0b 00 00       	mov    %eax,0xb38
}
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
 647:	5d                   	pop    %ebp
 ...
 656:	72 ce                	jb     626 <free+0x26>
{
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 38 0b 00 00       	mov    %eax,0xb38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 38 0b 00 00    	mov    0xb38,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6db:	3b 05 38 0b 00 00    	cmp    0xb38,%eax
 6e1:	75 ed                	jne    6d0 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 6e3:	83 ec 0c             	sub    $0xc,%esp
 6e6:	56                   	push   %esi
 6e7:	e8 af fc ff ff       	call   39b <sbrk>
  if(p == (char*)-1)
 ...
 6fe:	e8 fd fe ff ff       	call   600 <free>
  return freep;
 703:	8b 15 38 0b 00 00    	mov    0xb38,%edx
 ...
 72c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 72f:	89 15 38 0b 00 00    	mov    %edx,0xb38
}
 ...
 73f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 38 0b 00 00 3c 	movl   $0xb3c,0xb38
 747:	0b 00 00 
    base.s.size = 0;
 74a:	b8 3c 0b 00 00       	mov    $0xb3c,%eax
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 3c 0b 00 00 3c 	movl   $0xb3c,0xb3c
 756:	0b 00 00 
    base.s.size = 0;
 759:	c7 05 40 0b 00 00 00 	movl   $0x0,0xb40
 760:	00 00 00 
    if(p->s.size >= nunits){
