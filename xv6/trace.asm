  ...
  11:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  38:	52                   	push   %edx
  39:	52                   	push   %edx
  3a:	68 f8 06 00 00       	push   $0x6f8
  3f:	6a 02                	push   $0x2
  41:	e8 aa 03 00 00       	call   3f0 <printf>
    exit();
  46:	e8 58 02 00 00       	call   2a3 <exit>
      printf(2, "Error al cambiar trace\n");
  4b:	50                   	push   %eax
  4c:	50                   	push   %eax
  4d:	68 0a 07 00 00       	push   $0x70a
  52:	6a 02                	push   $0x2
 ...
 358:	89 d1                	mov    %edx,%ecx
{
 ...
 38b:	0f b6 92 84 07 00 00 	movzbl 0x784(%edx),%edx
 ...
 3f9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 464:	ff 24 85 2c 07 00 00 	jmp    *0x72c(,%eax,4)
 ...
 570:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 575:	bb 22 07 00 00       	mov    $0x722,%ebx
