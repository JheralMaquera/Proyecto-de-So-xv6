...
_trace:     formato del fichero elf32-i386
  ...
  11:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  27:	e8 17 03 00 00       	call   343 <trace>
  2c:	83 c4 10             	add    $0x10,%esp
  2f:	85 c0                	test   %eax,%eax
  31:	78 18                	js     4b <main+0x4b>
  ...
  38:	52                   	push   %edx
  39:	52                   	push   %edx
  3a:	68 08 07 00 00       	push   $0x708
  3f:	6a 02                	push   $0x2
  41:	e8 ba 03 00 00       	call   400 <printf>
    exit();
  46:	e8 58 02 00 00       	call   2a3 <exit>
      printf(2, "Error al cambiar trace\n");
  4b:	50                   	push   %eax
  4c:	50                   	push   %eax
  4d:	68 1a 07 00 00       	push   $0x71a
  52:	6a 02                	push   $0x2
  54:	e8 a7 03 00 00       	call   400 <printf>
  59:	83 c4 10             	add    $0x10,%esp
  5c:	eb d5                	jmp    33 <main+0x33>
  5e:	66 90                	xchg   %ax,%ax
 ...
 368:	89 d1                	mov    %edx,%ecx
{
 ...
 39b:	0f b6 92 94 07 00 00 	movzbl 0x794(%edx),%edx
 ...
 409:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 474:	ff 24 85 3c 07 00 00 	jmp    *0x73c(,%eax,4)
 ...
 580:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 585:	bb 32 07 00 00       	mov    $0x732,%ebx
